...
<!--         <tr>
          ...
          <td></td>
          <td></td>
          <td><input type="button" name="" value="已维修"></td>
        </tr> -->
        <s:iterator value="#request.repairs">        
			<tr>				
	          	<td class="hide"><input type="checkbox" value="<s:property value="repairId"/>"></td>	          	
				...
				<td><s:date name="receiveTime" format="yyyy-MM-dd" var="rvdate"/><s:property value="rvdate"/></td>
	          	<td style="float:none;">
	          		<form action="../mainst/finish" style="width:50px;">
			          	<input type="text" name="repairId" style="display:none" value="<s:property value="repairId"/>">
			          	<input type="text" name="finishTime" style="display:none" class="repairtime">
			          	<input type="submit" value="已维修" id="mainstSubmit"  style="margin:0;top:0;width:100px;">
		          	</form>
	          	</td>
			</tr>
		</s:iterator>
        <tr style="background:white;">
          ...
          <td></td>
          <td class="hide">
          	<form action="../mainst/finish" id="form-mainstAll">
          		<div style="display:none" id="mainstSubmitAll">     			
          		</div>
          		<input type="button"  value="已维修" class="Ssave" id="SRepaired">
          	</form>          	
          </td>
        </tr>
      </table>
