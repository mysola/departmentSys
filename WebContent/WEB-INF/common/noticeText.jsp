...
<!-- 通知详情 -->
  <main class="notic_detail">
    <div class="header">
      <span class="img">
        <img src="../static/img/home.png" width="15" height="15">
      </span>
      <span class="head_content">
        <a href="javascript:void(0);" class="url-index">首页</a>
         >
        <a href="javascript:void(0);" class="url-notice">通知公告</a>
         >
        <span>通知标题</span>
      </span>
    </div>
    <div class="notic_body">
      <div class="notic_title">
      	<s:property value="#request.notice.title"/>
      </div>
      <div class="notic_time">
      	<s:date name="#request.notice.time" format="yyyy-MM-dd" var="date"/>
      	<s:property value="date"/>
      </div>
      <div class="notic_text">
      	<s:property value="#request.notice.text"/>
      </div>
    </div>
  </main>
  <footer>
