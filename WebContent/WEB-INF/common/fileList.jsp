...
<link rel="stylesheet" type="text/css"
	href="../static/css/notic_down.css">
...
<body>
	...
	<main class="notic">
	<div class="header">
		<span class="img"> <img src="../static/img/home.png" width="15"
			height="15">
		</span> <span class="head_content"> <a href="javascript:void(0);" class="url-index">首页</a> > <span>相关下载</span>
		</span>
	</div>
	<div class="pad_center">
		<ul>
			<s:iterator value="#request.files">
				<li><a
					href="../common/downloadFile?fileId=<s:property value="fileId"/>">
						<s:property value="title" /> 
					</a> <span><s:date name="time" format="yyyy-MM-dd" var="date"/> <s:property value="date" /></span>
				</li>
			</s:iterator>
		</ul>
	</div>
